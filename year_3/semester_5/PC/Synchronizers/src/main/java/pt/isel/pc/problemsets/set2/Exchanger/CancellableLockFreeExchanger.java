...
/**
 * Exchanger lock-free implementation similar to {@link LockFreeExchanger}. This implementation now handles
 * interruptions.
 * @see IExchanger for more documentation
 */
public class CancellableLockFreeExchanger<V> implements IExchanger<V> {
